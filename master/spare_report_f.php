 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="add_spare_consumption.php">Spare Consumption Report </a>  </h1> 
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
                  ...
                  //  $query=mysqli_query($con,"SELECT * From fault,subproduct,Product ,Brigade where fault.product = subproduct.product and subproduct.product = Product.Id  and fault.unit= Brigade.Id") ;                    
                   ...
                   $query=mysqli_query($con,"SELECT 
                    sum(sparerequest.request) as www,
                    sparerequest.Unit,
                    Brigade.Brigade
                    From sparerequest 
                    inner join Brigade on sparerequest.Unit=Brigade.Id 
                    where sparerequest.Unitcat='$id' 
                    group By sparerequest.Unit") ;                   
                   ...
                   /*   $unit =$res['Unit'];
                    ...
                    ?>
                      <tr>
                          ...
                          <td><a href="spare_report_t.php?id=<?php echo $Product?>"><?php echo $Unitcat?></a></td>

...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">linking Type</h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php">Dashboard</a></li>
        <li class="active">linking Type</li>
      </ol>
...
if(isset($_POST['addsubmit']))
{
  ...
  $q = mysqli_query($con,"insert into linkingtype (`linkingtypename`,`isactive`) values('$linkingtypename','$isactive')");
  if($q){
    echo '<script>alert("Add Successfully.");window.location.assign("manage_linkingtype.php");</script>';
  }
  else{
      echo '<script>alert("please Add Again....");window.location.assign("add_linkingtype.php");</script>';
  }
}
?>
            ...
            <div class="panel-body">
              <form accept-charset="UTF-8" role="form" method="post" class="form-horizontal" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name = "linkingtypename" id="linkingtypename" required>
                  </div>
                </div>
                 <div class="form-group">

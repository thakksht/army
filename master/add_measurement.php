...
if(isset($_POST['addsubmit']))
{
  ...
  //echo "insert into measurement (`name`,`isActive`) values('$name','$isactive')";
  $q = mysqli_query($con,"insert into measurement (`name`,`isactive`) values('$name','$isactive')");
  //die('hloo');
  if($q){
    echo '<script>alert("Add Successfully.");window.location.assign("manage_measurement.php");</script>';
  }
  else{
      echo '<script>alert("please Add Again....");window.location.assign("add_measurement.php");</script>';
  }

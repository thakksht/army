 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="#"> Spare Consumption Report </a>  </h1> 
        ...
        <div class="panel-body table-responsive">
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
           ...
           //  echo "SELECT sum(Qty) From add_consumption where  Unitcat ='$Product'";
                     $qy1=mysqli_query($con,"SELECT  sum(Qty),id From add_consumption where  Unitcat ='$Product'") ;  
                    
                    if(mysqli_num_rows($qy1))
                   { 
                    $res21=mysqli_fetch_assoc($qy1);
                   {
                        //echo "hhh".row[0];
                      $Q1=$res21 ['sum(Qty)'];
             //$Q1= sum(Qty) ;
             $id=$res21["id"];
                    ...
                    ?>
                      <tr>
                          ...
                          <td><a href="spare_report_f.php?id=<?php echo $res['Unitcat'];?>"><?php echo  $res['Unitcat'];?></a></td>
                          
                         <?php 
                         
                         ?>
                          <td><?php echo  $Q1=$res21 ['sum(Qty)'];?></td>
                          <?php
                          }}
                       else
                       {?>
                         <td><a href="spare_report_f.php?id=<?php echo $id;?>"><?php echo  $res['Unitcat'];?></a></td>
                   <td> <?php 

 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="add_spare_consumption.php">Requirement Report </a>  </h1> 
      <h5>As on <?php echo date("Y/m/d")?></h5>
    </div>
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
                  ...
                  //  $query=mysqli_query($con,"SELECT * From fault,subproduct,Product ,Brigade where fault.product = subproduct.product and subproduct.product = Product.Id  and fault.unit= Brigade.Id") ;                    
                   ...
                   Brigade.Brigade
                    ...
                    INNER JOIN unitcat ON manpower_requirement.Unitcat=unitcat.id
                    INNER JOIN Brigade ON manpower_requirement.Unit=Brigade.Id
                    INNER JOIN vehicle ON manpower_requirement.vehicle=vehicle.Id
                    INNER JOIN trade ON manpower_requirement.trade=trade.Id and manpower_requirement.Unitcat='$id'") ;
                 //  $query=mysqli_query($con,"SELECT * from manpower_requirement where manpower_requirement.Unitcat='$id'") ; 

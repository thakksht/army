...
if($status == 'delete'){
  $sql = "DELETE FROM Product WHERE Id = $subcategoryid";
  if ($con->query($sql) === TRUE) {
            ...
            <table id="example0" class="table display">
                ...
                <tbody>
                  <?php //echo "select * from Brigade";
                    $query=mysqli_query($con,"SELECT Product.Id,Product.Product,Product.Date,category_product.cat_prod from Product INNER JOIN category_product WHERE Product.catprod=category_product.id") ;                                       
                    ...
                    ?>
                      <tr>
                         ...
                         <!-- <td><?php 
                          ...
                          ?></td>-->
                          <td><a href="edit_product_pro.php?Id=<?php echo $Id ?>"><i class="fa fa-edit"></i></a>
                           <a style="margin-left: 20px;" href="manage_product.php?status=delete&Id=<?php echo $Id ?>"><i class="fa fa-close"></i></a></td>

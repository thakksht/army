    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
          ...
          $qu=mysqli_query($con,"select *  from fault  where product='$unitcat' group by product ") ;                    
                            if(mysqli_num_rows($qu)>0)
                           { 
                            while($res1=mysqli_fetch_assoc($qu)){
                            //  $Id =$res1['Id'];
               ...
               if($unit!=''){
                   $q2=mysqli_query($con, "SELECT COUNT(*) FROM `fault` where unit='$unit' group by unitcat") ; 
               }else{
                    ...
                    ?>
                      ...
                      <tr> 
                         ...
                         // echo ($T- $s);
                          ?><!--</td>-->
                         <td><?php echo $s1?></td>
                          <td><a href="part_listing1.php?unitcat=<?php echo $unitcat?>&unittt=<?php echo $unit?>&fault=NMC"><?php echo $ncm ?></a></td>
                         ...
                         <!-- <td><a href="product_listing.php?unitcat=<?php echo $unitcat?>&unit=<?php echo $unit?>"><?php   echo  $pcm ;?></a></td>-->
                           <td><a href="part_listing1.php?unitcat=<?php echo $unitcat?>&unittt=<?php echo $unit?>&fault=PMC"><?php echo $pcm ?></a></td>

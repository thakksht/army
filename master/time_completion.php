...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="">Recovery Forecast Report </a>  </h1> 
...
<form action="getrecordstime.php" method="post">
            <table id="example0" class="table display">
                <thead>
                   ...
                   <option value="">Hours</option>
                    ...
                    $qu=mysqli_query($con,"select distinct(timecompletion) from recovery ") ;                    
                    if(mysqli_num_rows($qu)>0)
                   { 
                    while($res1=mysqli_fetch_assoc($qu)){
                      $Id =$res1['Id'];
                      $Brigade =$res1['timecompletion'];
                      ?>
          ...
          $qu=mysqli_query($con,"select * from recovery  ") ;                    
                            if(mysqli_num_rows($qu)>0)
                       //    { 
                       //     while($res1=mysqli_fetch_assoc($qu)){
                              $Id =$res1['timecompletion'];

 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="add_spare_consumption.php">Casuality Report </a>  </h1> 
        ...
        <div class="panel-body table-responsive">
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
                  ...
                  //  $query=mysqli_query($con,"SELECT * From fault,subproduct,Product ,Brigade where fault.product = subproduct.product and subproduct.product = Product.Id  and fault.unit= Brigade.Id") ;                    
                   ...
                   //$query=mysqli_query($con,"SELECT * from manage_casuality INNER JOIN trade ON manage_casuality.trade=trade.Id INNER JOIN manpower_link ON manpower_link.trade=manage_casuality.trade and manage_casuality.Unitcat='$id'") ;
                   $query=mysqli_query($con,"SELECT 
                    ...
                    INNER JOIN unitcat ON manage_casuality.Unitcat=unitcat.id
                    INNER JOIN Brigade ON manage_casuality.category=Brigade.Id
                    INNER JOIN vehicle ON manage_casuality.vehicle=vehicle.Id
                    LEFT JOIN manpower ON manage_casuality.person=manpower.Id
                    INNER JOIN trade ON manage_casuality.trade=trade.Id and manage_casuality.Unitcat='$id'") ; 

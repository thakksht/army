...
if(isset($_POST['addsubmit']))
{
 ...
 //echo "insert into batch (`vehicle`,`unit`,`isactive`) values('$vehicle','$unit',$isactive')";
     ...
     //die("gagaga");
$q = mysqli_query($con,"insert into trade (`trade`,`isactive`) values('$category','$isactive')");
        ...
        <div class="panel-title">
          ...
          <ul class="panel-tools">
            ...
            <div class="panel-body">
              <form accept-charset="UTF-8" role="form" method="post" class="form-horizontal" action="form_report.php" >
             <div class="form-group">
                ...
                <div class="col-sm-10">
                   ...
                   <option value=""> Unit</option>
                    ...
                    $qu=mysqli_query($con,"select distinct(Unitcat) from unitcat where isactive = 1") ;                    

...
{
  $Brigade = $_POST['category'];
 /* $isactive = $_POST['isactive'];*/


//print_r($_POST);
//die('hloo');
  $q = mysqli_query($con,"insert into category (`category`,`isactive`) values('$Brigade','1')");
  if($q){
            ...
            <div class="panel-body">
              <form accept-charset="UTF-8" role="form" method="post" class="form-horizontal" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name = "category" id="Brigade" required>
                  </div>
                </div>

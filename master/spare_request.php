...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Spare Request</h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php">Dashboard</a></li>
        <li class="active">Add Spare Request</li>
      </ol>
...
/*  $isactive = $_POST['isactive'];*/
  ...
  //echo "insert into sparerequest(`Unitcat`,`unit`,`Product`,`Equipment`,`Qty`,`isactive`,`date`) values('$unit','$cat','$prod','$part','$qty','$isactive','$date')";
  
    // die("gagaga");
    
 $qry1="insert into sparerequest(`Unitcat`,`unit`,`Product`,`Equipment`,`request`,`time`,`isactive`,`date`) values('$unit','$cat','$prod','$part','$request','$time','1','$date')";
...
//$q = mysqli_query($con,"insert into fault (`product`,`part`,`batchno`,`unitcat`,`unit`,`date`,`fault`,`killtype`,`typefault`,`timerequried`,`catprod`,`isactive`) values('$prod','$part','$batchno','$unit','$unit','$date','$fault','$killtype','$typefault','$timerequried','$catprod','$isactive')");
  ...
  if($q){
    echo '<script>alert("Add Successfully.");window.location.assign("manage_sparerequest.php");</script>';
  }
  else{
      echo '<script>alert("please Add Again....");window.location.assign("spare_request.php");</script>';
  }
}
?>
...
/*
 ...
 ?>
                  ...
                  <div class="col-sm-10">
                  <div id="select_box">
 <select onchange="fetch_select1(this.value);"  class="selectpicker" name="unit1" required>
  <option>Product</option>
  <?php
...
<div class="col-sm-10">
          <select id="new_select1" name="equipment" >
             ...
             <!--   <div class="form-group">
                ...
                <div class="form-group">
                  <label for="subcategoryname" class="col-sm-2 control-label form-label">Request</label></label>
                  <div class="col-sm-10">
                    <input type="text" class="" name = "request" id="quantity" required>
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="subcategoryname" class="col-sm-2 control-label form-label">Time</label></label>
                  <div class="col-sm-10">
                    <select name="time">

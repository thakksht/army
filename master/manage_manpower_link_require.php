 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="man_power_link.php">Add Manpower Requirement </a>  </h1> 
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
               ...
               //$query=mysqli_query($con,"SELECT trade.Id,manpower_link.trade,manpower_link.cat_unit,manpower_link.Unit,manpower_link.vehicle,manpower_link.batch,manpower_link.name,manpower_link.date,trade.trade From manpower_link INNER JOIN trade ON trade.Id=manpower_link.trade");
               $query=mysqli_query($con,"select trade.trade,manpower_requirement.Unit,manpower_requirement.vehicle,manpower_requirement.requirement,manpower_requirement.batch,manpower_requirement.date,manpower_requirement.Unitcat from manpower_requirement INNER JOIN trade ON manpower_requirement.trade=trade.Id");

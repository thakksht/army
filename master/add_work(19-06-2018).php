...
//print_r($_POST);
//die('hloo');
  $q = mysqli_query($con,"insert into work (`worktype`,`workdate`,`linking1`,`linking2`,`linking3`,`isactive`) values('$worktype','$workdate','$linking1','$linking2','$linking3','$isactive')");
  if($q){
...
<script>
  ...
  $('#summernote').summernote();
   ...
   // alert(value);
    ...
    for(i=1;i<=number;i++)
    {
      text +='<div class="form-group"><label class="col-sm-2 control-label form-label">Link type '+i+'</label><div class="col-sm-10"><input type="text" class="form-control" name = "linking1[]" id="linking1" ></div></div>';

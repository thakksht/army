...
//print_r($_POST);
//die('hloo');
  $q = mysqli_query($con,"insert into category_product (`Cat_prod`,`isactive`,`Date`) values('$Product','1','$date')");
  if($q){
    echo '<script>alert("Add Successfully.");window.location.assign("manage_category_product.php");</script>';
  }
  else{
      echo '<script>alert("please Add Again....");window.location.assign("add_product_category.php");</script>';
  }
}
?>
            ...
            <div class="panel-body">
              <form accept-charset="UTF-8" role="form" method="post" class="form-horizontal" >
                ...
                <div class="form-group">
                  <label for="category" class="col-sm-2 control-label form-label">Add Product Category</label>
                  <div class="col-sm-10">

    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
          ...
          $qu=mysqli_query($con,"select distinct(unitcat) from fault ") ;                    
                            if(mysqli_num_rows($qu)>0)
                           { 
                            while($res1=mysqli_fetch_assoc($qu)){
                            //  $Id =$res1['Id'];
       ...
       if($unit!=''){
               ...
               $pcm=$res11['COUNT(*)'] ;
                ...
                <tr>
                         <td>Total</td>
                      <?php
                        $result=mysqli_query($con,"SELECT count(*) as total from fault");
                        $data=mysqli_fetch_assoc($result);               

                      ?>
                    <td><?php echo $data['total']; ?></td>
                    <?php
                      $result=mysqli_query($con,"SELECT count(*) as total from fault WHERE fault='S'");
                      $data=mysqli_fetch_assoc($result);               

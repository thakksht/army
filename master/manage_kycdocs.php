...
if($status == 'delete'){
 ...
 ?>
  ...
  <div class="page-header">
    <h1 class="title">Manage KYC Doc</h1>
      <ol class="breadcrumb">
        <li><a href="index.html">Dashboard</a></li>
        <li><a href="#">Tables</a></li>
        <li class="active">Manage KYC Doc</li>
      </ol>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
                ...
                <tbody>
                  <?php
                    $query=mysqli_query($con,"select * from user where status = 'Approval Pending'") ;                    
                    ...
                    ?>
                      <tr>
                       ...
                       <td><?php echo $res['id']?></td>
                          ...
                          <td><?php echo $res['kycdate']?></td>
                          <td><?php echo $res['status']?></td>
                          <td>
                           <a href="kyc.php?id=<?php echo $id?>">KYC</a> </td>

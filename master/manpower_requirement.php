...
if($status == 'delete'){
  $sql = "DELETE FROM manpower_requirement WHERE id = $subcategoryid";
  if ($con->query($sql) === TRUE) {
 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="manpower_requirement_add.php">Add Manpower Requirement </a>  </h1> 
                    ...
                    ?>
                      <tr>
                         ...
                         <!-- <td><?php if($res['isactive'] == 1){
                          ...
                          <td><a href="edit_manpower_requirement.php?Id=<?php echo $ID ?>"><i class="fa fa-edit"></i></a>
                          <a style="margin-left: 20px;" href="manpower_requirement.php?status=delete&batchid=<?php echo $ID ?>"><i class="fa fa-close"></i></a>
                          </td>

...
if($status == 'delete'){
  $sql = "DELETE FROM sparerequest WHERE Id = $subcategoryid";
  if ($con->query($sql) === TRUE) {
                    ...
                    ?>
                      <tr>
                         ...
                         <!-- <td><?php if($res['isactive'] == 1){
                          ...
                          <td><a href="edit_spare_request.php?Id=<?php echo $id ?>"><i class="fa fa-edit"></i></a>
                          <a style="margin-left: 20px;" href="manage_sparerequest.php?status=delete&batchid=<?php echo $id ?>"><i class="fa fa-close"></i></a>
                          </td>

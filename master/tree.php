...
// }
 ?>
  ...
  <div class="page-header">
    <h1 class="title">Manage Tree</h1>
      <ol class="breadcrumb">
        <li><a href="index.html">Dashboard</a></li>
        <li><a href="#">Tables</a></li>
        <li class="active">Manage Tree</li>
      </ol>
                     ...
                     // {
                        ...
                        while($r = mysqli_fetch_object($res))
                        {
                          //echo $r->name;
                            ...
                            {
                              $query_count = "Select count(*) as leftcount from user where sponsorid = $rm->id";
                              $res_count = mysqli_query($con, $query_count);
                              $rmc = mysqli_fetch_object($res_count);
                                 // binarytree($rm->id, $con, $level);
                                  //echo $rm->name;
                                  echo '<tr>                
                                    <td>'.$rm->id.'</td>
                                   <td>'.$rm->name.' ('.$rmc->leftcount.')</td>
                                    <td>'.$rm->level.'</td>

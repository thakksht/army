 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="#">Spare Consumption Analysis Report</a>  </h1> 
        ...
        <div class="panel-body table-responsive">
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
                  ...
                  //  $query=mysqli_query($con,"SELECT * From fault,subproduct,Product ,Brigade where fault.product = subproduct.product and subproduct.product = Product.Id  and fault.unit= Brigade.Id") ;                    
                   // $query=mysqli_query($con,"SELECT add_consumption.Product,Product.Product,sum(add_consumption.Qty),add_consumption.id From add_consumption INNER JOIN Product ON add_consumption.Product=Product.Id group By add_consumption.Product") ;  
                 //   $query=mysqli_query($con,"SELECT DISTINCT(Unitcat)From add_consumption") ;  
                 
                    //$query=mysqli_query($con,"SELECT * From add_consumption") ;  
                     $query=mysqli_query($con,"SELECT Product.Product,sum(add_consumption.Qty),Product.Id From add_consumption INNER JOIN Product ON add_consumption.Product=Product.Id  group By add_consumption. Product") ;  
           ...
           //  echo "SELECT sum(Qty) From add_consumption where  Unitcat ='$Product'";
                  ...
                  //  if(mysqli_num_rows($qy1))
                //   { 
                //    $res21=mysqli_fetch_array($qy1);
                 //  {
                        //echo "hhh".row[0];
                //      $Q1=$res21 ['sum(request)'];
             //$Q1= sum(Qty) ;
            // $id=$res21["id"];
                    ...
                    ?>
                      <tr>
                          ...
                          <td><a href="spare_reportanalysis_f.php?id=<?php echo $res[2];?>"><?php echo  $res[1];?></a></td>

...
//die('hloo');
$date=date("Y/m/d");
  $q = mysqli_query($con,"insert into Brigade (`Brigade`,`unitcategory`,`date`,`isactive`) values('$Brigade','$unitcat','$date','1')");
  if($q){
    echo '<script>alert("Add Successfully.");window.location.assign("manage_brigade.php");</script>';
  }
  else{
            ...
            <div class="panel-body">
              <form accept-charset="UTF-8" role="form" method="post" class="form-horizontal" >
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   ...
                   <option value="">Formations</option>
                    ...
                    $qu1=mysqli_query($con,"select * from unitcat where isactive = 1") ;                    
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name = "Brigade" id="Brigade" required>
                  </div>
                </div>

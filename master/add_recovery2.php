...
echo "INSERT INTO `recovery`(`unit`, `vehicle`,`product`, `natureCAS`, `timeCAS`, `typerecovery`, `REC`, `timecompletion`, `GR`, `remark`, `isactive`) values('$unit','$vehicle','$product','$natureCAS','$timeCAS','$typerecovery','$REC','$timecompletion','$GR','$remark','$isactive')";
 die("fgfd");
  $q = mysqli_query($con,"INSERT INTO `recovery`(`unit`, `vehicle`,`product`, `natureCAS`, `timeCAS`, `typerecovery`, `REC`, `timecompletion`, `GR`, `remark`, `isactive`) values('$unit','$vehicle','$product','$natureCAS','$timeCAS','$typerecovery','$REC','$timecompletion','$GR','$remark','$isactive')");
  if($q){
...
<select id="country"  onchange="fetch_select4(this.value);" name="cat_id">
...
<select id="state" onchange="fetch_select5(this.value);" name="category" >
    <option value="">Select cat first</option>
</select>

<select id="city" onchange="fetch_select6(this.value);" name="vehicle_id">
    <option value="">Select vehicle first</option>
</select>
<select id="batch" name="unitvehicle">

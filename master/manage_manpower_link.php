...
if($status == 'delete'){
  $sql = "DELETE FROM manpower_link WHERE Id = $subcategoryid";
  if ($con->query($sql) === TRUE) {
 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="man_power_link.php">Add Grouping </a>  </h1> 
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
          ...
          //  "SELECT * From fault,Product,subproduct where fault.product =Product.Product and subproduct.product = Product.Id and Brigade.Id=batch.unit";
               ...
               $query=mysqli_query($con,"SELECT trade.Id,
                manpower_link.id,
                manpower_link.trade,
                unitcat.Unitcat,
                Brigade.Brigade,
                    ...
                    ?>
                      <tr>
                         ...
                         <!-- <td><?php if($res['isactive'] == 1){
                          ...
                          <td><a href="edit_man_power_link.php?Id=<?php echo $ID ?>"><i class="fa fa-edit"></i></a>
                          <a style="margin-left: 20px;" href="manage_manpower_link.php?status=delete&batchid=<?php echo $ID ?>"><i class="fa fa-close"></i></a>
                          </td>

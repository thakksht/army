...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="">Battle Worthiness State Report-Prod </a>  </h1> 
      <h2>CCC<?php
         $unitcat=$_GET['unitcat'];
                  @$unittt=$_GET['unittt'];
                   @$newproduct=$_GET['p'];
           echo  ">"."$unitcat".">"."$unittt".">"."$newproduct";       
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
          ...
          category_product.cat_prod
            ...
            LEFT JOIN category_product ON category_product.id=Product.catprod 
            WHERE fault.product='$unitcat' and fault.fault='$fault'");
                    if(mysqli_num_rows($q2)>0)
                   { 
                    while($res2=mysqli_fetch_assoc($q2))
                    {
                     
               $product1=$res2['Product']; 
               $part= $res2['part']; 

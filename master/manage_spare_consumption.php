...
if($status == 'delete'){
  $sql = "DELETE FROM add_consumption WHERE Id = $subcategoryid";
  if ($con->query($sql) === TRUE) {
 ...
 ?>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><a href="add_spare_consumption.php">Add Spare Consumption </a>  </h1> 
                    ...
                    ?>
                      <tr>
                         ...
                         <!-- <td><?php if($res['isactive'] == 1){
                          ...
                          <td><a href="edit_spare_consumption.php?Id=<?php echo $Id ?>"><i class="fa fa-edit"></i></a>
                          <a style="margin-left: 20px;" href="manage_spare_consumption.php?status=delete&batchid=<?php echo $Id ?>"><i class="fa fa-close"></i></a>
                          </td>
